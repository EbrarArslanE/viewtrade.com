...
// 1. ADIM: Grafik bileşeni her zaman ANA BİLEŞENİN DIŞINDA olmalı
  ...
  function App() {
    ...
    const yasKontrol = (girilenYas) => {
      ...
      return (
      <div className="min-h-screen p-4 md:p-8 font-cyber-tech selection:bg-neon-green selection:text-black bg-[#1a1d1e] text-white">
        {/* Üst Bar / Navigasyon */}
            ...
            <div className="bg-gradient-to-br from-neon-green/10 to-transparent border border-neon-green/20 rounded-01 p-6">
              ...
              <div className="flex items-center pb-5 justify-start gap-6">
                ...
                <div className="flex items-center justify-center">
                  <input className="input w-[300px] bg-[#1a1d1e] text-[#f4f4f5] px-3 py-1 rounded-l-lg border border-white/10 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 focus:ring-offset-[#09090b] transition-all duration-150 ease-in-out" name="text" type="text" placeholder="Almak İstediğiniz Tutar" />
